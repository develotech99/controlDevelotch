    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-[#0B1120] relative overflow-hidden">
        ...
        <div class="relative z-10 sm:max-w-md w-full px-8 py-10 bg-[#0f172a]/90 backdrop-blur-xl shadow-[0_0_40px_rgba(0,246,255,0.1)] border border-[#1e293b] sm:rounded-3xl">
            <div class="flex flex-col items-center justify-center mb-8">
                ...
                <h2 class="text-3xl font-black text-white tracking-tight text-center">RESTAURAR CONTRASEÑA</h2>
            </div>
            ...
            <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input id="email" class="block mt-1 w-full bg-[#0B1120]/50 border border-[#1e293b] focus:border-[#00f6ff] focus:ring focus:ring-[#00f6ff]/20 rounded-xl text-white shadow-sm placeholder-slate-700 transition-colors py-3 px-4" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" />
                    <x-input-error :messages="$errors->get('email')" class="mt-2 text-rose-400" />
                </div>

                <div>
                    <label for="password" class="block font-medium text-xs text-slate-400 uppercase tracking-widest mb-1">Nueva contraseña</label>
                    <input id="password" class="block mt-1 w-full bg-[#0B1120]/50 border border-[#1e293b] focus:border-[#00f6ff] focus:ring focus:ring-[#00f6ff]/20 rounded-xl text-white shadow-sm placeholder-slate-700 transition-colors py-3 px-4" type="password" name="password" required autocomplete="new-password" />
                ...
                <div>
                    ...
                    <input id="password_confirmation" class="block mt-1 w-full bg-[#0B1120]/50 border border-[#1e293b] focus:border-[#00f6ff] focus:ring focus:ring-[#00f6ff]/20 rounded-xl text-white shadow-sm placeholder-slate-700 transition-colors py-3 px-4" type="password" name="password_confirmation" required autocomplete="new-password" />
